...
TARGET_ARCH="arm64"
[[ -f "$KERNEL_ROOT_DIR/arch/$TARGET_ARCH/configs/vendor/taoyao_defconfig" ]] && \
KERNEL_CONFIG="vendor/taoyao_defconfig" \
|| KERNEL_CONFIG="vendor/taoyao_defconfig"
ZIP_KERNEL_STR="coreLinux"
ZIP_DEVICE_NAME="taoyao"
ZIP_PREFIX_STR="WildAngel-v1.0"
