...
const char * const tx_master_ch_text_ptr[] = {
...
const struct soc_enum tx_master_ch_enum_ptr =
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(tx_master_ch_text_ptr),
					tx_master_ch_text_ptr);
...
static const struct snd_kcontrol_new wcd938x_snd_controls[] = {
	...
	SOC_ENUM_EXT("ADC1 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("ADC2 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("ADC3 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("ADC4 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC0 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC1 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("MBHC ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC2 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC3 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC4 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC5 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC6 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC7 ChMap", tx_master_ch_enum_ptr,
			wcd938x_tx_master_ch_get, wcd938x_tx_master_ch_put),
};
